...
public class EnderecoController {
    ...
    public long salvarEndereco(String logradouro, String numero, String bairro, String cidade, String uf) {
        String validacao = validarEndereco(logradouro, numero, bairro, cidade, uf);
        if (!validacao.isEmpty()) {
            // Se houver erros de validação, retorna um número negativo.
            return -1;
        }

        Endereco endereco = new Endereco(0, logradouro, numero, bairro, cidade, uf); // 0 é um placeholder para o código.
    ...
    public String validarEndereco(String logradouro, String numero, String bairro, String cidade, String uf) {
